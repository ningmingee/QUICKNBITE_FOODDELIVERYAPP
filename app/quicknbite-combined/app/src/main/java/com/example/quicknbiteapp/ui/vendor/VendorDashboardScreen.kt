...
fun DashboardContent(
    vendor: com.example.quicknbiteapp.data.model.Vendor,
    reviewStats: ReviewStats,
    orders: List<Order>,
    ...
    LazyColumn(
        ...
        item {
            Column(
                ...
                val pendingOrders = orders.count { it.status == com.example.quicknbiteapp.data.model.OrderStatus.PENDING }
                val completedOrders = orders.count { it.status == com.example.quicknbiteapp.data.model.OrderStatus.COMPLETED }
                ...
                val activeOrders = orders.filter { it.status != com.example.quicknbiteapp.data.model.OrderStatus.COMPLETED }
