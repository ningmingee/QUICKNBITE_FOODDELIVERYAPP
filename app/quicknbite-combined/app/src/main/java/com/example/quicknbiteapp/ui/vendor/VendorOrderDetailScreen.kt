...
fun VendorOrderDetailScreen(
    ...
    val order = remember { derivedStateOf {
        (uiState as? com.example.quicknbiteapp.ui.state.VendorUiState.Success)
...
@Composable
fun OrderHeaderSection(order: com.example.quicknbiteapp.data.model.Order) {
    Card(
...
@Composable
fun OrderTimelineSection(order: com.example.quicknbiteapp.data.model.Order) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        colors = CardDefaults.cardColors(
            containerColor = MaterialTheme.colorScheme.surface
...
@Composable
fun OrderSummarySection(order: com.example.quicknbiteapp.data.model.Order) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        colors = CardDefaults.cardColors(
            containerColor = MaterialTheme.colorScheme.surface
...
@Composable
fun OrderItemRow(item: com.example.quicknbiteapp.data.model.OrderItem) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
