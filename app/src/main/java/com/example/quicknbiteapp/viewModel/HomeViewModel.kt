...
class HomeViewModel : ViewModel() {
    ...
    private val _restaurants = listOf(
        Restaurant("fatburger", "FatBurger", "Jalan Burma", R.drawable.fatburger_recommend, hasMenu = true),
        Restaurant("layers_bakeshop", "Layer's Bakeshop", "Cafe Town", R.drawable.dessert, hasMenu = true),
        Restaurant("pizzah_ut", "Pizza Hut", "Vantage Tanjung Tokong", R.drawable.pizzahut, hasMenu = false),
        Restaurant("burger_king", "Burger King", "Tanjung Bungah", R.drawable.burger_king, hasMenu = false),
